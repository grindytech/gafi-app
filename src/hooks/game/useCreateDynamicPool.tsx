...
export default function useCreateDynamicPool(
  onSuccess: () => void,
  ...
  const mutation = useMutation(
    async (params: {
      ...
      const txExecute = api?.tx.game.createDynamicPool(
        params.lootTable,
        params.fee,
        params.admin
      );
    ...
    {
      mutationKey: 'game-create-dynamic-pool',
      onError: (error: Error) => {
        toast({
          position: 'top-right',
  ...
  return { isLoading, createDynamicPool };
}
