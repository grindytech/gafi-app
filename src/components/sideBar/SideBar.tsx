...
const Sidebar: React.FC<IProps> = (props) => {
  ...
  const createLinks = (routes: any) => {
    ...
    // TODO: Remove any when routes type defined
...
interface ISidebarResponseProps {
  logoText: string;
  // TODO: define type for routes
  routes: any;
  secondary: boolean;
...
export const SidebarResponsive: React.FC<ISidebarResponseProps> = (props)=> {
  // to check for active links and opened collapses
  let location = useLocation();
  // this is for the rest of the collapses
  const [state, setState] = React.useState({});
  ...
  const createLinks = (routes: any) => {
    ...
    return routes.map((prop: any) => {
      ...
      if (prop.category) {
        var st = {};
        // TODO: Remove this when add type
        // @ts-ignore
        st[prop["state"]] = !state[prop.state];
        return (
          <>
