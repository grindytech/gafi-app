...
import { ListWeb3Project } from 'layouts/default/DefaultWeb3';
import Web3Project from './components/Web3Project';

export default function Web3() {
  const { isOpen, onToggle } = useDisclosure();
  return (
    <>
      <Text mb={4} onClick={onToggle}>
        trying make project by dev
      </Text>
