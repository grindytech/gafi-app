...
import TopFightGame from 'layouts/MarketPlace/Home/HomeTopFightGame';
import ExplorerNFTsTabDetail from './ExplorerNFTsTabDetail';
import ExplorerNFTsActivityTable from './ExplorerNFTsActivityTable';

export default function ExplorerNFTsDetail() {
