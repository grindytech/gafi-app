...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    faucet: {
       ...
       **/
      genesisAccounts: AugmentedQuery<
        ApiType,
    ...
    game: {
       ...
       **/
      addingAcceptance: AugmentedQuery<
        ApiType,
       ...
       **/
      auctionConfigOf: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletGameAuctionConfig>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Storing bundle
       **/
      bundleOf: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Vec<GafiSupportGameTypesPackage>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      game: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletGameGameDetails>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      highestBidOf: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<ITuple<[AccountId32, u128]>>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      lootTableOf: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Vec<GafiSupportGameTypesLoot>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      nextGameId: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Storing next mining pool id
       **/
      nextPoolId: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Storing next trade id
       **/
      nextTradeId: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Storing the original items of the upgraded items
       **/
      originItemOf: AugmentedQuery<
        ApiType,
        (
          arg:
            | ITuple<[u32, u32]>
       ...
       **/
      poolOf: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletGamePoolDetails>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      randomSeed: AugmentedQuery<ApiType, () => Observable<U8aFixed>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Storing reserved balance
       **/
      reservedBalanceOf: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array,
       ...
       **/
      supplyOf: AugmentedQuery<
        ApiType,
        (
          arg1: u32 | AnyNumber | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<Option<u32>>>,
        [u32, u32]
      > &
        QueryableStorageEntry<ApiType, [u32, u32]>;
      /**
       ...
       **/
      tradeConfigOf: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletGameTradeConfig>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      upgradeConfigOf: AugmentedQuery<
        ApiType,
        (
          arg1: u32 | AnyNumber | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array,
          arg3: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletGameUpgradeItemConfig>>,
        [u32, u32, u32]
      > &
    ...
    nfts: {
      ...
      collection: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletNftsCollectionDetails>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      collectionConfigOf: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletNftsCollectionConfig>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
      ...
      collectionMetadataOf: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletNftsCollectionMetadata>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      nextCollectionId: AugmentedQuery<
        ApiType,
    ...
    palletCache: {
      dataFlag: AugmentedQuery<ApiType, () => Observable<PalletCacheFlag>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Holding the data that insert in Cache by keys AccountId and Action
       **/
      dataLeft: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: AccountId32 | string | Uint8Array
        ) => Observable<Option<PalletCacheWrapData>>,
      ...
      > &
        QueryableStorageEntry<ApiType, [AccountId32, AccountId32]>;
      markTime: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
