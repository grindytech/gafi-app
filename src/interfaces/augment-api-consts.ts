...
declare module '@polkadot/api-base/types/consts' {
  export interface AugmentedConsts<ApiType extends ApiTypes> {
    ...
    gafiMembership: {
      maxAchievement: u32 & AugmentedConst<ApiType>;
      maxMembers: u32 & AugmentedConst<ApiType>;
      minJoinTime: u128 & AugmentedConst<ApiType>;
      totalMembershipLevel: u32 & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
    ...
    palletWhitelist: {
      whitelistFee: u128 & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
    ...
    pool: {
      maxJoinedSponsoredPool: u32 & AugmentedConst<ApiType>;
      timeServiceStorage: u128 & AugmentedConst<ApiType>;
      /**
       * Generic const
       **/
      [key: string]: Codec;
