          ...
          <Box position="relative">
            ...
            <Flex position="absolute" bottom={0} margin={3}>
              <AvatarPopover type="Owner" address={owner} name="-">
                <AvatarJazzicon value={owner} />
              </AvatarPopover>

              <AvatarPopover type="Admin" address={admin} name="-">
                <AvatarJazzicon value={admin} />
              </AvatarPopover>
            </Flex>
          </Box>
            ...
            <Center justifyContent="space-between">
              ...
              <Menu placement="top-start">
                <MenuButton
                  ...
                  color={lootOfTable.length ? 'primary.a.200' : 'shader.a.400'}
                  borderRadius="2xl"
                  px={2}
                  py={1}
                >
                            ...
                            {maybeNft.isSome ? (
                              <>
                                ...
                                <Box flex={1} wordBreak="break-word">
                                  <Text color="white">
                                    {currentMetaNFTChild?.title || 'unknown'}
                                    &nbsp;
                                    <Text
                                      as="span"
                                      fontWeight="normal"
                              ...
                              <>
                                ...
                                <Box flex={1} wordBreak="break-word">
                                  <Text color="second.red">Failed state</Text>
