...
import NFTsAddSupplyModal from './NFTsAddSupplyModal';

export interface NFTsAddSupplyFieldProps extends TypeSwitchAdmin {
  collection_id: number;
  item_id: number;
  supply: number;
}

export default function NFTsAddSupply() {
  const { getValues, setValue, handleSubmit, control, watch, reset } =
    useForm<NFTsAddSupplyFieldProps>();
