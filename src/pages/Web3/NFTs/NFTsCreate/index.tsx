...
export interface NFTsCreateFieldProps extends TypeSwitchAdmin {
...
import NFTsCreateModal from './NFTsCreateModal';

export default function NFTsCreate() {
  const { setValue, getValues, handleSubmit, watch, reset, control } =
    useForm<NFTsCreateFieldProps>();
