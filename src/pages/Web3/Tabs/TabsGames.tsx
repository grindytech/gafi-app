...
import { TagOfCollection } from './TabsCollections';

export interface TabsGamesDataProps {
  owner: string;
  role: string;
  game_id: number;
  collection: number[];
...
interface TabsGamesProps {
  data: TabsGamesDataProps[];
}

export default function TabsGames({ data }: TabsGamesProps) {
  return (
    <Grid
      gridTemplateColumns={{
        sm: 'repeat(2, 1fr)',
