...
export interface TabsCollectionsDataProps {
  owner: string;
  role: string;
...
interface TabsCollectionsProps {
  data: TabsCollectionsDataProps[];
}
...
export default function TabsCollections({ data }: TabsCollectionsProps) {
